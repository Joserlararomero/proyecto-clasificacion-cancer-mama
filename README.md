...
|Columnas|Tipo|Descrición|
|--------|----|----------|
|id |Entero|→ identificador del registro (se elimina)|
|diagnosis |Categoria|→ M para maligno, B para benigno|
...
- git clone [Proyecto de Clasificación](https://github.com/Joserlararomero/proyecto-clasificacion-cancer-mama)
